...
URL = f"{BASE_URL}/en/core-functions/supervision/financial-service-providers/factoring-companies"
...
def get_matched_text_for_patterns(page_text_div:BeautifulSoup):
    ...
    for pattern in pattern_list:
        p_tag=page_text_div.find("strong",string=pattern).parent
        if p_tag:
            cleaned_data=get_cleaned_data(p_tag)
