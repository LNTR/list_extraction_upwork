...
# NOTE : The Website was empty. But the script will work correctly when new data are inserted
...
URL = f"{BASE_URL}/en/core-functions/supervision/financial-service-providers/register-of-credit-intermediaries"
...
def add_data_to_df(html):
    ...
    if not children_listing_div:
        print("There are no data to be scraped")
        return
