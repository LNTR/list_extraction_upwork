...
columns = ["Administrative territorial circleand the villages covered by it",
           "representative for the administrative territorial district",
           "contact"]

df = pd.DataFrame(columns = columns)

BASE_URL="http://gedebey-ih.gov.az/az/numayendelikler.html"
