...
AJAX_URL = "https://live.euronext.com/en/ajax/getIndexCompositionFull/FR0003502079-XPAR"
...
def get_row_data_list(tr):
    ...
    for td in tr.find_all("td"):
        if td.find("a"):
            ...
            row_data_list.append(td.text.strip().replace("ø","oe").replace("ö","oe"))
    if len(row_data_list)<5:
        row_data_list.insert(1,None)
