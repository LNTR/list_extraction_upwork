...
columns = ["role","Surname/Firstname" ,"qualification","Contact","Unit"]

df = pd.DataFrame(columns = columns)

BASE_URL="http://gedebey-ih.gov.az/az/aparatin-strukturu.html"
