...
columns = ["role","Surname/Firstname" ,"Contact","Unit"]

df = pd.DataFrame(columns = columns)

BASE_URL="http://qazax-ih.gov.az/az/aparatin-strukturu.html"
...
def add_data_to_df(html):
    ...
    unit_name=""
    for tr in tr_list:
        if ("Əlaqə telefonu" in tr.text): #Əlaqə telefonu means "position" in english
            continue
